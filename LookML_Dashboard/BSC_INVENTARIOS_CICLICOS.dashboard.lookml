...
- dashboard: bsc_inventarios_ciclicos
  ...
  description: ''
  preferred_slug: lHF3AFRJlrv4wy9TFiKvAl
  elements:
  ...
  - title: Diferencia y exactitud
    ...
    explore: inventarios_ciclicos
    type: looker_grid
    fields: [planta.planta_completo, inventarios_ciclicos.exactitud, inventarios_ciclicos.diferencia]
    filters: {}
    sorts: [planta.planta_completo]
    limit: 500
    column_limit: 50
    total: true
    show_view_names: false
