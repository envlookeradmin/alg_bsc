---
- dashboard: bsc_manufactura
  title: BSC_MANUFACTURA
  layout: newspaper
  preferred_viewer: dashboards-next
  description: ''
  preferred_slug: 4WF16LfYWPQHUxnbeqwm2P
  elements:
  - title: MANUFACTURA
    name: MANUFACTURA
    model: bsc
    ...
    type: looker_grid
    fields: [planta.nombre_planta, fct_manufactura.Linea_producto, fct_manufactura.Puesto_trabajo,
    ...
    hidden_pivots: {}
    listen:
      Fecha: fct_manufactura.date_filter
  ...
  - name: Fecha
    ...
    explore: fct_manufactura
    listens_to_filters: []
    field: fct_manufactura.date_filter
  - name: Planta
    title: Planta
    type: field_filter
    default_value: ''
