view: tiempos_estadia {
    ...
    dimension: PlantaCompleto {
      ...
      link: {
        label: "Maniobra"
        url: "https://envases.cloud.looker.com/dashboards/135?&Fecha={{ _filters['tiempos_estadia.date_filter'] | url_encode }}&Planta={{ tiempos_estadia.Planta._value | url_encode}}"
      }
    }
