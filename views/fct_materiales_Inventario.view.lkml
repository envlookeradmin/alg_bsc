view: materiales_inventario {
  derived_table: {
    sql:
        ...
        ar.tipo AS TIPO_NC
        FROM `envases-analytics-qa.RPT_S4H_MX.tbl_fact_materiales_stock` ms
        left join `envases-analytics-qa.RPT_S4H_MX.cat_grupo_articulos` as ar
          ON GRUPO_MATERIAL = grupo
          WHERE
           GRUPO_MATERIAL in (
                      'BAS1010','DPL1012','LID1015','OPP1018','BFT1012','DPL1014','LID1017','PAI1017','BLI1018',
